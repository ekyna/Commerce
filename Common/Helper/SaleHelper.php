...
class SaleHelper
{
    ...
    /**
     * Returns whether sale (items) price and discount can be update automatically.
     *
     * @param Common\SaleInterface $sale
     *
     * @return bool
     */
    public static function isSalePriceLocked(Common\SaleInterface $sale): bool
    {
        return $sale->isSample()
            || self::isSaleWithPayment($sale)
            || self::isSaleWithShipment($sale)
            || self::isSaleWithInvoice($sale);
    }
